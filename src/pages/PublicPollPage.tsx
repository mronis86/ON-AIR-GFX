...
import { getPollBackupSheetName, postToWebApp, getRailwayBaseUrlForSheet } from '../services/googleSheets';
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      if (poll?.eventId) {
        ...
        const pollBackupEnabled = eventData?.googleSheetWebAppUrl?.trim();
